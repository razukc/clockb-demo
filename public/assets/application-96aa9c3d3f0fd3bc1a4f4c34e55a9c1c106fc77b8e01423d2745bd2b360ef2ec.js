    ...
    $(function(){
      setTimeout(function(){
        $('.readmore').readmore({
          ...
          lessLink: '<a href="#" class="button tiny info right clearfix" style="width:auto;margin-top:10px;">Close</a>',
...
$(function(){
		...
		//removing duplicate events day displays
...
//
  ...
  $(document).ready(function(){
    $("input[type=radio][name='user[inputs][company]']").change(function() { 
      ...
      $("label[for='user_inputs_company_address']").toggle();
      $("label[for='user_inputs_year_founded']").toggle();
      $("label[for='user_inputs_number_of_employees']").toggle();
      $("label[for='user_inputs_website']").toggle();
    } );
  });
