  ...
  CKEDITOR.dialog.add("link", function(g) {
    var n = CKEDITOR.plugins.link,
      p = function() {
        ...
        if (b && a) switch (b = b.getElement(), b.hide(), a.setValue(""), m) {
            case "frame":a.setLabel(g.lang.link.targetFrameName);a.getElement().show();
              break;case "popup":b.show();a.setLabel(g.lang.link.targetPopupName);a.getElement().show();
              break;default:a.setValue(m), a.getElement().hide()
        }
      },
      f = function(a) {
    ...
    return {
        ...
        elements: [{
          ...
          children: [{
            ...
            children: [{
              ...
              setup: function(a) {
                this.allowOnChange = !1;a.url && this.setValue(a.url.url);
                this.allowOnChange = !0
              },
              commit: function(a) {
                this.onChange();a.url || (a.url = {});
      ...
      onShow: function() {
        ...
        this._.selectedElement = c;this.setupContent(a)
      },
      onOk: function() {
        var a = {};
        ...
        if (this._.selectedElement) {
          var e = this._.selectedElement,
            ...
            f = e.getHtml();
          e.setAttributes(c.set);e.removeAttributes(c.removed);
